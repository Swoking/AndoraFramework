...
use App\Shop\Action\GalionListingAction;
...
use App\Shop\Action\RankListingAction;
...
class ShopModule extends Module
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $router->get('/rank', RankListingAction::class, 'shop.rank');
        $router->get('/galion', GalionListingAction::class, 'shop.galion');

        //$router->get('/boutique', ProductListingAction::class, 'shop');
        $router->get('/boutique/{id}/download', [LoggedInMiddleware::class, ProductDownloadAction::class], 'shop.download');
        $router->post('/boutique/{id}/recap', [LoggedInMiddleware::class, PurchaseRecapAction::class], 'shop.purchase');
        $router->post('/boutique/{id}/process', [LoggedInMiddleware::class, PurchaseProcessAction::class], 'shop.process');
